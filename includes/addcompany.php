...
<form name="addcompany" id="fm-form" method="post"
	action="company.php?addcompany">
<fieldset><legend>Company Information</legend>
<div class="fm-req"><label for="fm-comlicno">Com License No:</label>
<input name="fm-comlicno" id="fm-comlicno" type="text" /></div>
<div class="fm-req"><label for="fm-name">Company Name:</label> <input
	id="fm-name" name="fm-name" type="text" /></div>
</fieldset>

<fieldset><legend>Address</legend>
<div class="fm-opt"><label for="fm-addr">Address:</label> <input
	id="fm-addr" name="fm-addr" type="text" /></div>
<div class="fm-opt"><label for="fm-city">City:</label> <input
...
<div class="fm-req"><label for="fm-postalcode">Zip code:</label> <input
	id="fm-postalcode" name="fm-postalcode" type="text" /></div>
</fieldset>

<fieldset><legend>Contact Information</legend>
<div class="fm-req"><label for="fm-manager">Manager:</label> <input
	id="fm-manager" name="fm-manager" type="text" /></div>
<div class="fm-req"><label for="fm-telephone">Telephone:</label> <input
	id="fm-telephone" name="fm-telephone" type="text"
	title="Enter Phone Number in xxx-xxx-xxxx format" /></div>
</fieldset>

<fieldset><legend>Policy Information</legend>
<div class="fm-req"><label for="fm-policy">Policy:</label> <select
	...
	require $classfolder.'policyclass.php';
		...
		$companypolicies = $policyinstance->getAllCompanyPolicy(); //Get all company policies
		$temp;
