<div id="container"><!-- p id="fm-intro" required for 'hide optional fields' function -->
	...
	<fieldset>
		...
		<div class="fm-req">
			...
			<input id="fm-claimid" name="fm-claimid" type="text" disabled <?php print "value=\"".$claim['Claim_No']."\" ";?> />
		</div>
		<div class="fm-req">
			<label for="fm-amount">Claim Amount:</label>
			<input id="fm-amount" name="fm-amount" type="text" <?php print "value=\"".$claim['Amount']."\" ";?> />
		</div>
		<div class="fm-req">
			<?php 
				$token="-./ ";
		...
		<div class="fm-req">
			...
			<textarea name="fm-description" id="fm-description"><?php print $claim['Description']?></textarea>
		</div>
		<div class="fm-req">
	...
	<fieldset>
		...
		<div class="fm-req">
			...
			<input id="fm-tp-name" name="fm-tp-name" type="text" <?php print "value=\"".$thirdparty['Party_Name']."\" ";?> />
		</div>
		<div class="fm-req">
			<label for="fm-tp-insurer">Insurer Name:</label>
			<input id="fm-tp-insurer" name="fm-tp-insurer" type="text" <?php print "value=\"".$thirdparty['Insurer_Name']."\" ";?> />
		</div>
		<div class="fm-req">
			<label for="fm-tp-phone">Insurer Phone:</label>
			<input id="fm-tp-phone" name="fm-tp-phone" type="text" <?php print "value=\"".$thirdparty['Phone']."\" ";?> />
		</div>
		<div class="fm-req">
			<label for="fm-tp-address">Insurer Address:</label>
			<input id="fm-tp-address" name="fm-tp-address" type="text" <?php print "value=\"".$thirdparty['Address']."\" ";?> />
		</div>
		<div class="fm-req">
			<label for="fm-tp-rep">Representative:</label>
			<input id="fm-tp-rep" name="fm-tp-rep" type="text" <?php print "value=\"".$thirdparty['Insurer_Rep']."\" ";?> />
		</div>
		<div class="fm-req">
			<label for="fm-tp-year">Vehicle Year:</label>
			<input id="fm-tp-year" name="fm-tp-year" type="text" <?php print "value=\"".$thirdparty['Vehicle_Year']."\" ";?> />
		</div>
		<div class="fm-req">
			<label for="fm-tp-make">Make:</label>
			<input id="fm-tp-make" name="fm-tp-make" type="text" <?php print "value=\"".$thirdparty['Vehicle_Make']."\" ";?> />
		</div>
		<div class="fm-req">
			<label for="fm-tp-model">Model:</label>
			<input id="fm-tp-model" name="fm-tp-model" type="text" <?php print "value=\"".$thirdparty['Vehicle_Model']."\" ";?> />
		</div>
		<div class="fm-req">
			<label for="fm-tp-license">Driver's License Number:</label>
			<input id="fm-tp-license" name="fm-tp-license" type="text" <?php print "value=\"".$thirdparty['Party_License_No']."\" ";?> />
		</div>
	</fieldset>
	<fieldset>
	...
	<div class="fm-multi">
		<div class="fm-atfault">
			...
			<input name="fm-atfault" type="radio" id="fm-atfaultyes" value="1" <?php if($claim['Client_At_Fault']==1){print "checked ";}?> /> Yes</label>
			<label for="fm-atfaultno">
			<input id="fm-atfaultno" name="fm-atfault" type="radio" value="0" <?php if($claim['Client_At_Fault']==0){print "checked ";}?> /> No</label>
		</div>
	</div>
	<div id="fm-submit" class="fm-req"><input name="Submit" value="Submit" type="submit" /></div>
	</form>
</div>
